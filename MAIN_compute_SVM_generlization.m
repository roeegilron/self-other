...
for v = 2:vmp.NrOfMaps % first map has all voxels. 
...
if params.getAllVOI
    ...
    % first run of size defined in params
    jointmap = logical(maporig) & logical(mapvoi); % in 3d
